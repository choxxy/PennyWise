...
@AutoSubcomponent
@AutoInjector
@DaggerScope(ViewActivity.class)
public class ViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reminder = session.getReminderDao().loadByRowId(mReminderId);
    ...
    public void assignReminderValues() {
        ...
        iconImage.setImageResource(getResources().getIdentifier("ic_launcher", "drawable", getPackageName()));
        circleImage.setColorFilter(Color.parseColor("#CCFFDD"));
        ...
        if (reminder.getRepeatType() == Reminder.SPECIFIC_DAYS) {
            repeatText.setText(reminder.getDaysOfWeek());
        } else {
        ...
        if (Boolean.parseBoolean(reminder.getForeverState())) {
            ...
            shownText.setText(getString(R.string.times_shown, reminder.getNumberShown(), 1));
        }

        // Hide "Mark as done" action if reminder is inactive
        hideMarkAsDone = reminder.getActive() && !Boolean.parseBoolean(reminder.getForeverState());
    ...
    public void actionDelete() {
        session.getReminderDao().delete(reminder);
        Intent alarmIntent = new Intent(this, AlarmReceiver.class);
        AlarmUtil.cancelAlarm(this, alarmIntent, reminder.getId().intValue());
        Intent snoozeIntent = new Intent(this, SnoozeReceiver.class);
        AlarmUtil.cancelAlarm(this, snoozeIntent, reminder.getId().intValue());
        finish();
    }
    ...
    public void returnHome() {
        Intent intent = new Intent(this, PennyMain.class);
    ...
    public void updateReminder() {
        reminder = session.getReminderDao().loadByRowId(reminder.getId());
        assignReminderValues();
    }
