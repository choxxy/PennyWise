package com.iogarage.ke.pennywise.dialogs;
...
public class AdvancedRepeatSelector extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final NumberPicker numberPicker = view.findViewById(R.id.picker1);
        numberPicker.setMinValue(2);
        numberPicker.setMaxValue(999);
        numberPicker.setWrapSelectorWheel(false);

        final NumberPicker repeatPicker = view.findViewById(R.id.picker2);
